...
*/
    ...
    private void insertUserData(){
        ...
        /*else if(TextUtils.isEmpty(passwordConfirm)) {
            ...
            editTextTextPassword.setError("Confirmation Required");
            editTextTextPassword.requestFocus();
        }*/
        /*else if(!editTextTextPassword.equals(passwordConfirm)){
            Toast.makeText(RegisterPage.this,"Please Use The Same Password",Toast.LENGTH_SHORT).show();
            editTextTextPassword.setError("Confirmation Required");
            editTextTextPassword.requestFocus();*/
