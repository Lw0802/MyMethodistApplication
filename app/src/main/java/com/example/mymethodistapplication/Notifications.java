...
import com.example.mymethodistapplication.databinding.ActivityNotificationsBinding;
        ...
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem menuItem) {
                ...
                if (itemId == R.id.nav_Join_Us) {
                    Intent intent = new Intent(Notifications.this, JoinMinistryActivity.class);
                    startActivity(intent);
                    return true;
                }
                if (itemId == R.id.nav_Appointments) {
                    Intent intent = new Intent(Notifications.this, AppointmentsActivity.class);
                    startActivity(intent);
                    return true;
                }
                ...
                if (itemId == R.id.nav_About) {
                    Intent intent = new Intent(Notifications.this, ChooseLanguage.class);
                    startActivity(intent);
                    return true;
                }
